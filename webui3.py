...
def main():
    with gr.Blocks() as demo:
        ...
        audio_output = gr.Audio(label="合成音频", autoplay=True, streaming=False,show_download_button=True)
...
if __name__ == '__main__':
    ...
    cosyvoice = CosyVoice2(args.model_dir,load_jit=True, load_onnx=True, load_trt=False) if 'CosyVoice2' in args.model_dir else CosyVoice(args.model_dir)
